...
public class PrincipalUnidad0103 {
    ...
    public static void main(String[] args) {
        ...
        lugarMatricula1.ciudad=2;
        lugarMatricula1.provincia="Azuay";
        lugarMatricula1.telefono="411234";
        lugarMatricula1.descripcion="Centro Capulispamba";
        
        var lugarMatricula2 = new LugarMatricula();
        lugarMatricula2.ciudad=1;
        lugarMatricula2.provincia="Azuay";
        lugarMatricula2.telefono="09746327";
        lugarMatricula2.descripcion="Centro Gualaceo";
