...
public class Auto {
    ...
    public String mostrarInfo() {
         var retorno = " El auto tiene placa: " + this.placa + " es de marca: "
                ...
                + "El lugar de matricula es:" + this.lugar.descripcion
                + "El telefono del lugar de matriculacion es"
                + this.lugar.telefono + " la provincia de matriculacion es: " + this.lugar.provincia
                + "El numero de ciudad es: " + this.lugar.ciudad;
